                        ...
                        <div className="flex items-center lg:gap-x-4">
                            ...
                            <div className="ml-3 lg:ml-5 flex items-center gap-x-4 lg:gap-x-10">
                                ...
                                <button className="relative bgw" onClick={() => setIsOpen(!isOpen)}>
                                    {cartStore.length > 0 && <div className="absolute ml-2 -mt-[0.4rem] w-4 h-4 text-background rounded-full bg-red-500 text-xs flex items-center justify-center ">{cartStore.length}</div>}

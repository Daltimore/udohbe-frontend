                    ...
                    <div className="flex items-center gap-x-4">
                        ...
                        <div className=" ml-5 flex items-center gap-10">
                            ...
                            <svg width="18" height="21" viewBox="0 0 18 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="1" y="6" width="16" height="14" rx="2" stroke="#323232" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M5.5 6V5C5.5 3.067 7.067 1.5 9 1.5V1.5C10.933 1.5 12.5 3.067 12.5 5V6" stroke="#323232" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
